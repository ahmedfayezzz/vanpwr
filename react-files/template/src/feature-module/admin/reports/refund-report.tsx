...
import { RefundReportInterface } from '../../../core/models/interface';

const RefundReport = () => {
  const data = useSelector((state: RefundReportInterface) => state.refund_reports);
      ...
      <div className="content">
        <div className="content-page-header content-page-headersplit">
          ...
          <div className="list-btn">
            <ul>
              <li>
                <a className="btn-downloads down-pdf" href="javascript:;">
                  <ImageWithBasePath
              ...
              <li>
                <a className="btn-downloads down-excel" href="javascript:;">
                  <ImageWithBasePath
