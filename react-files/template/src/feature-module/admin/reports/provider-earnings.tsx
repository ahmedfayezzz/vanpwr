...
import { ProviderEarningsInterface } from '../../../core/models/interface';
...
const ProviderEarnings = () => {
  ...
  const data = useSelector((state: ProviderEarningsInterface) => state.provider_earnings_admin);
  return (
