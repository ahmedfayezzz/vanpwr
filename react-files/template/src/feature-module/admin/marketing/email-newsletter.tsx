...
import { NewslettersItem, emailletter } from '../../../core/models/interface';

const EmailNewsletter = () => {
  const [selectedValue, setSelectedValue] = useState(null);
  const data = useSelector((state: NewslettersItem) => state.newsletterData);
  const value = [{ name: 'A - Z' }, { name: 'Z - A' }];
  const [values, setValue] = React.useState();
  function onChange(e: emailletter) {
