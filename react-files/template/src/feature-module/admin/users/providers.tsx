...
import { Provider, providerRowData } from '../../../core/models/interface';
...
const Providers = () => {
  ...
  const providerStatus = (rowData: { status: { split: providerRowData } }) => {
  ...
  const data = useSelector((state: Provider) => state.providers);
